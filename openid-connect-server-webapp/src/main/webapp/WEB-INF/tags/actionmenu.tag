...
<security:authorize access="hasRole('ROLE_ADMIN')">
	...
	<li><a href="manage/#user/approved" data-toggle="collapse" data-target=".nav-collapse"><spring:message code="sidebar.administrative.approved_sites"/></a></li>
	<li><a href="manage/#user/tokens" data-toggle="collapse" data-target=".nav-collapse"><spring:message code="sidebar.administrative.active_tokens"/></a></li>
	<li class="divider"></li>
...
<li><a href="manage/#user/changepassword" data-toggle="collapse" data-target=".nav-collapse"><spring:message code="sidebar.personal.change_password"/></a></li>
