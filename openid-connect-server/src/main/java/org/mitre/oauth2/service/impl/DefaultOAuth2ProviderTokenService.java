...
public class DefaultOAuth2ProviderTokenService implements OAuth2TokenEntityService {
	...
	public OAuth2AccessTokenEntity createAccessToken(OAuth2Authentication authentication) throws AuthenticationException, InvalidClientException {
		...
		System.out.println("DefaultOAuth2ProviderTokenService.createAccessToken start");
		if (authentication != null && authentication.getOAuth2Request() != null) {
			System.out.println("DefaultOAuth2ProviderTokenService.createAccessToken authentication != null ");
			// look up our client
			OAuth2Request request = authentication.getOAuth2Request();
			System.out.println("DefaultOAuth2ProviderTokenService.createAccessToken request.getClientId() "+request.getClientId());
			...
			if (request.getExtensions().containsKey(CODE_CHALLENGE)) {
				System.out.println("DefaultOAuth2ProviderTokenService.createAccessToken request.getExtensions().containsKey(CODE_CHALLENGE)"+request.getExtensions().containsKey(CODE_CHALLENGE));
			...
			/*System.out.println("token tokentype"+token.getTokenType()+" getValue "+token.getValue());*/
			
			System.out.println("DefaultOAuth2ProviderTokenService.createAccessToken client"+client);
			// attach the client
			...
			System.out.println("DefaultOAuth2ProviderTokenService.createAccessToken request.getScope() "+request.getScope());
			...
			if (client.isAllowRefresh() && token.getScope().contains(SystemScopeService.OFFLINE_ACCESS)) {
				System.out.println("DefaultOAuth2ProviderTokenService.createAccessToken isAllowRefresh");
			...
			if (originalAuthRequest.getExtensions() != null && originalAuthRequest.getExtensions().containsKey("approved_site")) {
				System.out.println("DefaultOAuth2ProviderTokenService.createAccessToken originalAuthRequest.getExtensions");
			...
			System.out.println("DefaultOAuth2ProviderTokenService.createAccessToken savedToken "+savedToken);
