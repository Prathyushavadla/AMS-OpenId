...
public class AuthorizationRequestFilter extends GenericFilterBean {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
		...
		System.out.println("AuthorizationFilter.doFilter requestURI"+request.getRequestURI());
		// skip everything that's not an authorize URL
		if (!requestMatcher.matches(request)) {
			System.out.println("AuthorizationFilter.doFilter !requestMatcher.matches(request)");
