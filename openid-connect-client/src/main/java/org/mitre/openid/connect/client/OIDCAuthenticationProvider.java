...
public class OIDCAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(final Authentication authentication) throws AuthenticationException {
		System.out.println("OIDCAuthenticationProvider.authenticate start");
		...
		if (authentication instanceof PendingOIDCAuthenticationToken) {
			...
			System.out.println("OIDCAuthenticationProvider.authenticate name "+userInfo.getName()+" email "+userInfo.getEmail()+" address "+userInfo.getAddress()+" phone "+userInfo.getPhoneNumber());
