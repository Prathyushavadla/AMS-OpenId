...
public class OIDCAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
	...
	protected void handleAuthorizationRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
		System.out.println("OIDCAuthenticationFilter.handleAuthorizationRequest start");
		...
		System.out.println("OIDCAuthenticationFilter.handleAuthorizationRequest issResp.getRedirectUrl()"+issResp.getRedirectUrl());
		
		if (issResp.shouldRedirect()) {
			System.out.println("OIDCAuthenticationFilter.handleAuthorizationRequest issResp.shouldRedirect()");
			response.sendRedirect(issResp.getRedirectUrl());
		} else {
			System.out.println("OIDCAuthenticationFilter.handleAuthorizationRequest issResp.shouldRedirect() not");
			...
			if (clientConfig.getRegisteredRedirectUri() != null && clientConfig.getRegisteredRedirectUri().size() == 1) {
				...
				System.out.println("OIDCAuthenticationFilter.handleAuthorizationRequest getRequestURL"+request.getRequestURL().toString());
				redirectUri = request.getRequestURL().toString();
			}
			System.out.println("OIDCAuthenticationFilter.handleAuthorizationRequest redirectUri"+redirectUri);
			...
			System.out.println("OIDCAuthenticationFilter.handleAuthorizationRequest authRequest "+authRequest);
	...
	protected Authentication handleAuthorizationCodeResponse(HttpServletRequest request, HttpServletResponse response) {
		...
		System.out.println("serverConfig.getAuthorizationEndpointUri()"+serverConfig.getAuthorizationEndpointUri());
		...
		System.out.println("httpClient "+factory.getHttpClient());
		RestTemplate restTemplate;

		if (SECRET_BASIC.equals(clientConfig.getTokenEndpointAuthMethod())){
			System.out.println("OIDCFilter getTokenEndpointAuthMethod if");
			...
			System.out.println("OIDCFilter getTokenEndpointAuthMethod else");
		...
		System.out.println("OIDCAuthenticationFilter tokenEndpointURI " + serverConfig.getTokenEndpointUri());
		...
		try {
			...
			System.out.println("OIDCAuthenticationFilter.handleAuthorizationCodeResponse jsonString "+jsonString);
		...
		System.out.println("OIDCAuthenticationFilter.handleAuthorizationCodeResponse tokenResponse ");
		if (tokenResponse.get("error") != null) {
			...
			System.out.println("OIDCAuthenticationFilter.handleAuthorizationCodeResponse tokenResponse else");
			...
			System.out.println("OIDCAuthenticationFilter.handleAuthorizationCodeResponse bfore try ");
			try {
				...
				System.out.println("OIDCAuthenticationFilter.handleAuthorizationCodeResponse nonce "+nonce);
				...
				System.out.println("OIDCAuthenticationFilter.handleAuthorizationCodeResponse before PendingOIDCAuthenticationToken ");
				...
				System.out.println("OIDCAuthenticationFilter.handleAuthorizationCodeResponse before getAuthenticationManager ");
